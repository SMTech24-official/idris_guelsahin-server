        ...
        <div class="container">
          ...
          ${
            showButtons
              ? `
          <div class="buttons">
            <a href="${repoUrl}" class="btn btn-primary" target="_blank" rel="noopener noreferrer">
              View Repository
            </a>
            <a href="${docsUrl}" class="btn btn-secondary" target="_blank" rel="noopener noreferrer">
              Documentation
            </a>
          </div>
          `
